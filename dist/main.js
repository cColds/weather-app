...
function populateWeatherForecastInfo(response) {
	...
	for (let i = 0; i < weatherForecastDay.length; i += 1) {
		weatherForecastDay[i].textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(
