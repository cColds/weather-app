...
function formatTime(response) {
	return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(
...
function populateWeatherInfo(response) {
	...
	sunrise.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(
	...
	sunset.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(
		convertTimeToCitySearched(
			response,
...
function populateWeatherForecastInfo(response, weatherForecastList) {
	for (let i = 0; i < weatherForecastCards.length; i += 1) {
		weatherForecastCards[i].textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(
